## The makeCacheMatrix function and cacheSolve function are used for storing and
## caching the inverse of the matrix for future use. 
...
## Return Value : A list of methods that can be used for 
...
makeCacheMatrix <- function(x = matrix()) {
  ...
  # The "setInverse" function is used for storing the inverse of the matrix which can then be
  ...
  # via makeCacheMatrix. The inverseMatrix value may be NULL or an inverse matrix calculated
  ...
  # and the inverse stored for that matrix
...
## The cacheSolve function is used for returning the inverse of matrix. The matrix 
## MUST HAVE BEEN CREATED via the makeCacheMatrix function. The inverse may either be
...
## (b) retrieved from the cache of the matrix
